...
class CustomerCollectionScreen extends StatefulWidget {
  ...
  @override
  _CustomerCollectionScreenState createState() => _CustomerCollectionScreenState();
}
        ...
        builder: (context, state) {
          ...
          final filteredClients = clientsList.where((client) {
            return client.name.toLowerCase().contains(searchQuery.toLowerCase()) ||
                (client.phone?.toLowerCase().contains(searchQuery.toLowerCase()) ?? false);
          }).toList();
          ...
          return Column(
            ...
            children: [
                ...
                onSelected: (value) {
                  if (value != null) {
                    final selectedClient =
                        filteredClients.firstWhere((client) => client.id == value);
                    _recipientController.text = selectedClient.name;
                  }
                },
              ...
              Text(
                  "الرصيد الحالي للعميل: ${clientsList.firstWhere((client) => client.name == _recipientController.text, orElse: () => const Client(id: 0, name: '', address: '', balance: 0.0, lastPurchase: '', latitude: 0.0, longitude: 0.0)).balance}"),
